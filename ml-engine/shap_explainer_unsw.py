...
MODEL_PATH = "ml-engine/models/xgboost_unsw.joblib"
OUT_PATH = "ml-engine/models/shap_explanations_unsw.json"
...
def main():
    ...
    print("Building SHAP TreeExplainer (fast, exact for tree models)...", flush=True)
    explainer = shap.TreeExplainer(model)

    # Pick a mixed sample: some correctly-flagged attacks, some benign, for a representative demo
