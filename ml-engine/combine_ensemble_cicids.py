...
def main():
    ...
    iso_pred = np.load("ml-engine/models/iso_cicids_test_preds.npy")
    rf_pred = np.load("ml-engine/models/rf_cicids_test_preds.npy")
    xgb_pred = np.load("ml-engine/models/xgb_cicids_test_preds.npy")
    ae_pred = np.load("ml-engine/models/ae_cicids_test_preds.npy")
